...
namespace Co_owner_Vehicle.Services
{
	public class ReportsService : IReportsService
	{
		...
		public ReportsService(CoOwnerVehicleDbContext context)
		{
			_context = context;
		}
		...
		{
			var q = _context.Expenses.Where(e => e.CoOwnerGroupId == groupId);
		...
		{
			var q = _context.Payments.Include(p => p.Expense)
		...
		{
			var q = _context.Expenses.Include(e => e.ExpenseCategory)
		...
		{
			var q = _context.BookingSchedules
