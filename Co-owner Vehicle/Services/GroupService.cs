...
namespace Co_owner_Vehicle.Services
{
    public class GroupService : IGroupService
    {
        ...
        public GroupService(CoOwnerVehicleDbContext context)
        {
            _context = context;
        }
        ...
        {
            return await _context.CoOwnerGroups
                .Include(g => g.Vehicle)
        ...
        public async Task<CoOwnerGroup> CreateGroupAsync(CoOwnerGroup group)
        {
            ...
            _context.CoOwnerGroups.Add(group);
        ...
        public async Task<CoOwnerGroup> UpdateGroupAsync(CoOwnerGroup group)
        {
            ...
            _context.CoOwnerGroups.Update(group);
            await _context.SaveChangesAsync();
            return group;
        }
        ...
        {
            var group = await _context.CoOwnerGroups.FindAsync(groupId);
        ...
        {
            return await _context.OwnershipShares
                .Include(os => os.User)
        ...
        public async Task<bool> UpdateOwnershipShareAsync(int groupId, int userId, decimal percentage, decimal? investmentAmount)
        {
            ...
            else
            {
                ...
                _context.OwnershipShares.Add(ownershipShare);
            }
